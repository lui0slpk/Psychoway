...
function PsiDashboard() {
  ...
  return (
    <MainLayout pageTitle="Dashboard" pageSubtitle="Estadísticas del psicólogo" currentPage="psi-dashboard">
              ...
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5 className="mb-0 d-flex align-items-center gap-2">
                    <BarChart3 size={20} className="text-danger" /> Mis Alertas
                  </h5>
          ...
          <motion.div className="col-12" variants={itemVariants}>
            <div className="card border-0 shadow-sm rounded-4">
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h5 className="mb-0 d-flex align-items-center gap-2">
                    <Calendar size={20} className="text-success" /> Mis Reuniones
                  </h5>
