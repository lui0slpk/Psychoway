...
function GestionModPage() {
    ...
    const validaciones = {
        ...
        password: {
            ...
            tieneMayuscula: formData.password ? /[A-Z]/.test(formData.password) : true,
            tieneMinuscula: formData.password ? /[a-z]/.test(formData.password) : true,
            tieneNumero: formData.password ? /[0-9]/.test(formData.password) : true,
            tieneEspecial: formData.password ? /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(
                formData.password,
            ) : true,
        },
    };
                            ...
                            <form className="mt-3" onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    <label className="form-label">
                                        Confirmar contraseña {formData.password && <span className="text-danger">*</span>}
                                    </label>
                                    <div className="input-group">
                                        <input 
