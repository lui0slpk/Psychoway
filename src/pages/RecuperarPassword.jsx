      ...
      {showSuccess && (
        ...
        >
          ...
          >
            ...
            <h3 className="fw-bold text-success mb-2">¡Envío Exitoso!</h3>
      ...
      {showError && (
        ...
        >
          ...
          >
            ...
            <h3 className="fw-bold text-danger mb-2">¡Correo no encontrado!</h3>
            <p className="text-muted mb-0">
              El correo ingresado no se encuentra registrado en nuestra base de
              datos.
            </p>
            <p className="text-muted mt-2">Inténtalo de nuevo.</p>
          </div>
        </div>
      )}
