...
function ResetPassword() {
    ...
    const igualContraseña = form.confirmarContraseña === form.contraseña && form.contraseña.length > 0;
    const contraseñaValida = Object.values(validaciones.contraseña).every(Boolean);
